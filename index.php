    ...
    <div class="container">
      <div class="row">
        ...
        <div class="p-5 text-center">
          <a href="https://cth.daee.sp.gov.br/sibh/chuva_agora" target="_blank" class="btn btn-tranparent" data-aos="fade-up">Chuva
            Agora →</a>
...
<div class="d-flex justify-content-end-flex justify-content-end col-lg-4 offset-lg-2">
  ...
  <div class="buttonI" data-aos="fade-right" data-aos-delay="100">Níveis de Rios</div>
  <div class="buttonI" data-aos="fade-right" data-aos-delay="100">Níveis de Reservatórios</div>
  <div class="buttonI" data-aos="fade-right" data-aos-delay="100">Escassez Hídrica</div>
...
<section id="objetivo" class="objetivo p-5 ">
  <div class="container">
    <div class="row">
  <div class="col-lg-4 position-relative align-self-start order-lg-last order-last" data-aos="fade-up"
          data-aos-delay="200">
          <h5 class="text-align:center">Soluções para um Futuro Sustentável em cenários de Escassez</h5>
          <img src="assets/img/webnars/cenario_escassez.png" class="img-fluid" alt="">
          <a href="https://www.youtube.com/watch?v=_ChZnonviyw&t=516s" class="glightbox pulsating-play-btn"></a>
    </div>

      <div class="col-lg-4 position-relative align-self-start order-lg-last order-last" data-aos="fade-up"
          data-aos-delay="200">
          <h5>Desafios da Gestão de Recursos Hídricos Diante das Mudanças Climáticas</h5>
          <img src="assets/img/webnars/desafios_da_gestao.png" class="img-fluid" alt="">
          <a href="https://www.youtube.com/watch?v=w_egLCIUHfI&t=135s" class="glightbox pulsating-play-btn"></a>
    </div>

      <div class="col-lg-4 position-relative align-self-start order-lg-last order-last" data-aos="fade-up"
          data-aos-delay="200">
          <h5>Ações Integradas para Mitigação dos Impactos da Escassez Hídrica</h5>
          <img src="assets/img/webnars/escassezHidrica.png" class="img-fluid" alt="">
          <a href="https://www.youtube.com/watch?v=Hs3eAfDClN0" class="glightbox pulsating-play-btn"></a>
        </div>
</div>
</div>
</div>
