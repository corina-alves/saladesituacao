...
<body>
 <?php include "menuspgov.php";?>
  <header id="header" class="header  sticky-top"><?php include "nav.php";?></header>
        ...
        <img class="img-fluid" src="assets/img/posts/BM.png">
          <div class="container">
            <div class="row">
       <div class="col-lg-6 offset-lg-6" data-aos="fade-right">
          <h1><strong>Boletins Mensais</strong></h1>
          <p>Acompanhe os Boletins mensais da SSSP
        </div>
...
<div class="div-scroll">
    ...
    <form method="GET" class="mb-4 d-flex">
        ...
        <a href="boletinsMensais.php" type="button" class="btn btn-secundary">Limpar</a>
    </form>
