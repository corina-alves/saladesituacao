...
// Total de registros
$total_query = $conn->query("SELECT COUNT(*) as total FROM boletinsmensais");
$total_result = $total_query->fetch_assoc();
$total = $total_result['total'];
$total_paginas = ceil($total / $por_pagina);

// Consulta paginada
$sql = "SELECT * FROM boletinsmensais ORDER BY data_upload DESC LIMIT $inicio, $por_pagina";
...
<section class="boletins section">
   ...
   <div class="container areaBoletins">
        ...
        <div class="col-lg-12 p-3" data-aos="fade-up"> 
            <h1><strong>Boletins Mensais</strong></h1>
                        <a href="https://drive.google.com/drive/folders/0B4yicqLa_Dj8VFFVb3B4bW5xZkk?resourcekey=0-9rWDTUK16xaKOQnDIPFlnw" target=_blank type="button" class="btn btn-outline-primary">Boletins Anteriores</a>
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><a href="uploadsMensais/<?= $row['arquivo'] ?>" target="_blank" title="<?=$row['data_upload']?>">Visualizar</a></td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
