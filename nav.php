        ...
        <li><a href="sssp.php">Salas de Situação</a></li>
          ...
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>Boletins</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                    <li><a href="boletinsDiario.php">Boletim Diário</a></li>
                    <li><a href="boletinsMensais.php">Boletim Mensal</a></li>
                    <li><a href="boletinsHidrologico.php">Boletim Hidrológico</a></li>
                </ul>
            </li>
        <li><a href="hidrologia.php"><span>Hidrologia</span></a></li>
        <li><a href="contato.php"> Contato</a></li>
        <li class="logo"><a href="https://sp.gov.br/sp" target=_blank> <img src="https://sp.gov.br/statics/img/logo-gov.png"></a></li>
        </ul>
