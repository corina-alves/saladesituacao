...
<h1 class="mb-4">Boletins de SPI</h1>
...
<form method="GET" class="mb-4 d-flex">
    ...
    <a href="listagemBoletimMensal.php" class="btn btn-secondary ms-2">Limpar</a>
</form>
    ...
    <tbody>
        <?php if ($result->num_rows > 0): ?>
            ...
            <tr>
                ...
                <td>
                    <a href="editarBoletimHidrologico.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i> Editar</a>
                    <a href="excluirBoletimHidrologico.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Deseja excluir?');"><i class="bi bi-trash"></i> Excluir</a>
                </td>
            </tr>
            <?php endwhile; ?>
        <?php else: ?>
